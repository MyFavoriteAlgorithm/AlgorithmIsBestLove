...
'''
N = int(input())
count = 0 # 몇번째 종말의 수인지 카운트
num = 666 # 시작숫자

while(True):
    if '666' in str(num): # 숫자가 종말의 수일때 마다 카운트 +1
        count+=1
    
    if(count == N): # N번째 종말의 수 일시 반복종료
        break
    else:
        num+=1 # N번째 종말의 수가 아닐 시 +1후 반복

print(num)

'''
 666 1666 2666 3666 4666 5666 6660 6661 6662 6663 
6664 6665 6666 6667 6668 6669 10666 11666 12666 13666
14666 15666 16660 16661 16662 16663 26664 26665 26666 26667
'''